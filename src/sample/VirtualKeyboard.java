...
/***
 * VirtualKeyboard.java contains the logic of the keyboard
 */
...
public class VirtualKeyboard {
    ...
    public VirtualKeyboard(ReadOnlyObjectProperty<Node> target)
    {
        ...
        //includes special unicode characters for standard mathematical expressions
        //TODO: SIN COS TAN LOG LN do not input a value. There are no unicde format values.
        final String[][] unshifted = new String[][] {
                { "1", "2", "3", "4", "5", "6", "7", "8", "9", "0" },
                { "-", "+", "\u22C5", "/", "%", "\u221A","\u00B2","\u00B3","\u2211"},
                { "^","[", "]", "(", ")", "{", "}","\u222B","\u222C"},
                { "sin", "cos", "tan", "log", "ln", "\u03C0", "x", "y", "z"} };

        //extra keyboad buttons that appear when 'shift' is pressed on VK
    ...
    //Only modifiers shift and shift2 are used
